...
function App() {
  ...
  const parseInlineContent = useCallback((text: string): React.ReactNode => {
    function parseInline(t: string): React.ReactNode {
      const regex = /(\*\*[\s\S]*?\*\*|\[\[term:.*?\]\][\s\S]*?\[\[\/term\]\]|\[\[org-structure\]\]|\[\[dispute-resolution\]\]|\[\[bankruptcy-branch\]\]|\[\[secured-parties\]\]|\[\[dispatch-triangle\]\])/g;
          ...
          {parts.map((part, i) => {
            ...
            if (part === '[[org-structure]]') return (
              <figure key={key} className="bl-figure">
                <svg viewBox="0 0 340 234" role="img" aria-label="株式会社の機関設計：株主総会が取締役・監査役を選任し、取締役会が代表取締役を選定、監査役が取締役の職務執行を監査する関係図" className="bl-fig-svg">
                  <rect x={95} y={14} width={150} height={40} rx={6} fill="var(--primary-light)" stroke="var(--primary)" strokeWidth={1.6} />
                  <text x={170} y={40} textAnchor="middle" fontSize={20} fontWeight={700} fill="var(--primary-text)">株主総会</text>

                  <line x1={170} y1={54} x2={170} y2={70} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={91} y1={70} x2={265} y2={70} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={91} y1={70} x2={91} y2={98} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={265} y1={70} x2={265} y2={98} stroke="#94a3b8" strokeWidth={1.4} />
                  <polygon points="91,102 87,95 95,95" fill="#94a3b8" />
                  <polygon points="265,102 261,95 269,95" fill="#94a3b8" />
                  <text x={170} y={67} textAnchor="middle" fontSize={17} fontWeight={700} fill="var(--text-muted)">取締役・監査役を選任</text>

                  <rect x={16} y={102} width={150} height={40} rx={6} fill="var(--bg-warm)" stroke="var(--border-medium)" strokeWidth={1.4} />
                  <text x={91} y={128} textAnchor="middle" fontSize={17} fontWeight={700} fill="var(--text)">取締役会</text>

                  <rect x={190} y={102} width={150} height={40} rx={6} fill="var(--bg-warm)" stroke="var(--border-medium)" strokeWidth={1.4} />
                  <text x={265} y={128} textAnchor="middle" fontSize={17} fontWeight={700} fill="var(--text)">監査役（会）</text>

                  <line x1={91} y1={142} x2={91} y2={176} stroke="#94a3b8" strokeWidth={1.4} />
                  <polygon points="91,180 87,173 95,173" fill="#94a3b8" />
                  <text x={99} y={163} fontSize={17} fontWeight={700} fill="var(--text-muted)">選定・解職</text>

                  <rect x={16} y={180} width={150} height={40} rx={6} fill="var(--primary-light)" stroke="var(--primary)" strokeWidth={1.6} />
                  <text x={91} y={206} textAnchor="middle" fontSize={17} fontWeight={700} fill="var(--primary-text)">代表取締役</text>

                  <line x1={190} y1={122} x2={172} y2={122} stroke="var(--accent)" strokeWidth={1.4} strokeDasharray="3 2" />
                  <polygon points="168,122 175,118 175,126" fill="var(--accent)" />
                  <text x={187} y={112} textAnchor="middle" fontSize={17} fontWeight={700} fill="var(--accent)">監査</text>
                </svg>
            ...
            if (part === '[[dispute-resolution]]') return (
              <figure key={key} className="bl-figure">
                <svg viewBox="0 0 380 224" role="img" aria-label="紛争解決の方法の分岐：訴訟とADR、ADRはさらに調停と仲裁に分かれる" className="bl-fig-svg">
                  <rect x={95} y={14} width={150} height={36} rx={6} fill="var(--primary-light)" stroke="var(--primary)" strokeWidth={1.6} />
                  <text x={170} y={38} textAnchor="middle" fontSize={21} fontWeight={700} fill="var(--primary-text)">紛争解決の方法</text>

                  <line x1={170} y1={50} x2={170} y2={64} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={91} y1={64} x2={265} y2={64} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={91} y1={64} x2={91} y2={90} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={265} y1={64} x2={265} y2={90} stroke="#94a3b8" strokeWidth={1.4} />
                  <polygon points="91,94 87,87 95,87" fill="#94a3b8" />
                  <polygon points="265,94 261,87 269,87" fill="#94a3b8" />

                  <rect x={16} y={94} width={150} height={36} rx={6} fill="var(--bg-warm)" stroke="var(--border-medium)" strokeWidth={1.4} />
                  <text x={91} y={118} textAnchor="middle" fontSize={19} fontWeight={700} fill="var(--text)">訴訟</text>

                  <rect x={190} y={94} width={150} height={36} rx={6} fill="var(--bg-warm)" stroke="var(--border-medium)" strokeWidth={1.4} />
                  <text x={265} y={118} textAnchor="middle" fontSize={19} fontWeight={700} fill="var(--text)">ADR</text>

                  <line x1={265} y1={130} x2={265} y2={144} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={210} y1={144} x2={320} y2={144} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={210} y1={144} x2={210} y2={170} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={320} y1={144} x2={320} y2={170} stroke="#94a3b8" strokeWidth={1.4} />
                  <polygon points="210,174 206,167 214,167" fill="#94a3b8" />
                  <polygon points="320,174 316,167 324,167" fill="#94a3b8" />

                  <rect x={165} y={174} width={90} height={40} rx={6} fill="var(--primary-light)" stroke="var(--primary)" strokeWidth={1.6} />
                  <text x={210} y={200} textAnchor="middle" fontSize={19} fontWeight={700} fill="var(--primary-text)">調停</text>

                  <rect x={275} y={174} width={90} height={40} rx={6} fill="var(--primary-light)" stroke="var(--primary)" strokeWidth={1.6} />
                  <text x={320} y={200} textAnchor="middle" fontSize={19} fontWeight={700} fill="var(--primary-text)">仲裁</text>
                </svg>
                <figcaption className="bl-fig-cap">
            ...
            if (part === '[[bankruptcy-branch]]') return (
              <figure key={key} className="bl-figure">
                <svg viewBox="0 0 380 224" role="img" aria-label="倒産手続きの分岐：清算型の破産と、再建型の民事再生・会社更生" className="bl-fig-svg">
                  <rect x={95} y={14} width={150} height={36} rx={6} fill="var(--primary-light)" stroke="var(--primary)" strokeWidth={1.6} />
                  <text x={170} y={38} textAnchor="middle" fontSize={21} fontWeight={700} fill="var(--primary-text)">倒産手続き</text>
                  ...
                  <rect x={16} y={94} width={150} height={36} rx={6} fill="var(--bg-warm)" stroke="var(--border-medium)" strokeWidth={1.4} />
                  <text x={91} y={118} textAnchor="middle" fontSize={17} fontWeight={700} fill="var(--text)">清算型：破産</text>

                  <rect x={190} y={94} width={150} height={36} rx={6} fill="var(--bg-warm)" stroke="var(--border-medium)" strokeWidth={1.4} />
                  <text x={265} y={118} textAnchor="middle" fontSize={19} fontWeight={700} fill="var(--text)">再建型</text>
                  ...
                  <rect x={165} y={174} width={90} height={40} rx={6} fill="var(--primary-light)" stroke="var(--primary)" strokeWidth={1.6} />
                  <text x={210} y={200} textAnchor="middle" fontSize={18} fontWeight={700} fill="var(--primary-text)">民事再生</text>

                  <rect x={275} y={174} width={90} height={40} rx={6} fill="var(--primary-light)" stroke="var(--primary)" strokeWidth={1.6} />
                  <text x={320} y={200} textAnchor="middle" fontSize={18} fontWeight={700} fill="var(--primary-text)">会社更生</text>
                </svg>
                <figcaption className="bl-fig-cap">
            ...
            if (part === '[[secured-parties]]') return (
              <figure key={key} className="bl-figure">
                <svg viewBox="0 0 340 220" role="img" aria-label="担保をめぐる三者関係：債権者・主債務者・物上保証人" className="bl-fig-svg">
                  <rect x={115} y={14} width={110} height={36} rx={6} fill="var(--primary-light)" stroke="var(--primary)" strokeWidth={1.6} />
                  <text x={170} y={39} textAnchor="middle" fontSize={20} fontWeight={700} fill="var(--primary-text)">債権者</text>

                  <line x1={170} y1={50} x2={170} y2={64} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={81} y1={64} x2={259} y2={64} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={81} y1={64} x2={81} y2={90} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={259} y1={64} x2={259} y2={90} stroke="#94a3b8" strokeWidth={1.4} />
                  <polygon points="81,94 77,87 85,87" fill="#94a3b8" />
                  <polygon points="259,94 255,87 263,87" fill="#94a3b8" />
                  <text x={35} y={81} fontSize={17} fontWeight={700} fill="var(--text-muted)">返済義務</text>
                  <text x={259} y={81} textAnchor="middle" fontSize={17} fontWeight={700} fill="var(--text-muted)">担保提供のみ</text>

                  <rect x={16} y={94} width={130} height={40} rx={6} fill="var(--bg-warm)" stroke="var(--border-medium)" strokeWidth={1.4} />
                  <text x={81} y={120} textAnchor="middle" fontSize={17} fontWeight={700} fill="var(--text)">主債務者</text>

                  <rect x={194} y={94} width={130} height={40} rx={6} fill="var(--bg-warm)" stroke="var(--border-medium)" strokeWidth={1.4} />
                  <text x={259} y={120} textAnchor="middle" fontSize={17} fontWeight={700} fill="var(--text)">物上保証人</text>

                  <line x1={259} y1={134} x2={259} y2={158} stroke="var(--accent)" strokeWidth={1.4} strokeDasharray="3 2" />
                  <line x1={259} y1={158} x2={81} y2={158} stroke="var(--accent)" strokeWidth={1.4} strokeDasharray="3 2" />
                  <line x1={81} y1={158} x2={81} y2={138} stroke="var(--accent)" strokeWidth={1.4} strokeDasharray="3 2" />
                  <polygon points="81,134 77,141 85,141" fill="var(--accent)" />
                  <text x={170} y={175} textAnchor="middle" fontSize={17} fontWeight={700} fill="var(--accent)">求償権</text>
                </svg>
                <figcaption className="bl-fig-cap">
            ...
            if (part === '[[dispatch-triangle]]') return (
              <figure key={key} className="bl-figure">
                <svg viewBox="0 0 340 240" role="img" aria-label="労働者派遣の三者関係：派遣元・派遣先・労働者" className="bl-fig-svg">
                  <rect x={115} y={14} width={110} height={40} rx={6} fill="var(--primary-light)" stroke="var(--primary)" strokeWidth={1.6} />
                  <text x={170} y={40} textAnchor="middle" fontSize={19} fontWeight={700} fill="var(--primary-text)">派遣元</text>

                  <rect x={12} y={172} width={124} height={40} rx={6} fill="var(--bg-warm)" stroke="var(--border-medium)" strokeWidth={1.4} />
                  <text x={74} y={198} textAnchor="middle" fontSize={19} fontWeight={700} fill="var(--text)">労働者</text>

                  <rect x={204} y={172} width={124} height={40} rx={6} fill="var(--bg-warm)" stroke="var(--border-medium)" strokeWidth={1.4} />
                  <text x={266} y={198} textAnchor="middle" fontSize={19} fontWeight={700} fill="var(--text)">派遣先</text>

                  <line x1={140} y1={50} x2={90} y2={172} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={200} y1={50} x2={250} y2={172} stroke="#94a3b8" strokeWidth={1.4} />
                  <line x1={136} y1={192} x2={204} y2={192} stroke="var(--accent)" strokeWidth={1.4} strokeDasharray="3 2" />

                  <rect x={30} y={92} width={92} height={26} rx={5} fill="var(--card-bg)" stroke="#94a3b8" strokeWidth={1} />
                  <text x={76} y={110} textAnchor="middle" fontSize={15} fontWeight={700} fill="var(--text-muted)">雇用契約</text>

                  <rect x={214} y={92} width={92} height={26} rx={5} fill="var(--card-bg)" stroke="#94a3b8" strokeWidth={1} />
                  <text x={260} y={110} textAnchor="middle" fontSize={15} fontWeight={700} fill="var(--text-muted)">派遣契約</text>

                  <rect x={124} y={202} width={92} height={26} rx={5} fill="var(--card-bg)" stroke="var(--accent)" strokeWidth={1} />
                  <text x={170} y={220} textAnchor="middle" fontSize={15} fontWeight={700} fill="var(--accent)">指揮命令</text>
                </svg>
                <figcaption className="bl-fig-cap">
                  <strong>労働者を「雇う」のは派遣元</strong>（雇用契約で賃金支払い・社会保険加入）、<strong>「使う（指揮命令する）」のは派遣先</strong>（業務上の直接の使用関係）。派遣元と派遣先は派遣契約（役務提供）で結ばれる。「雇う人」と「使う人」が分離している点が、通常の雇用（会社←→労働者の二者関係）との決定的な違い。
                </figcaption>
              </figure>
            );
